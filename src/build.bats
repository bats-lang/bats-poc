...
implement do_build_wasm(release) = let
  ...
  val lrc = run_cmd(bv_ld, 524288, link_b)
...
in
  if r0 <> 0 then ()
    ...
    val nrt_r = run_cmd(bv_nrt_exec, 524288, nrt_argv)
    ...
    fn ensure_ats2 {l:agz}
      ...
      val rc = (if exists then 0
        ...
        val r1 = run_cmd(bv_ce, 524288, curl_argv)
        ...
        val r2 = run_cmd(bv_te, 524288, tar_argv)
        ...
        val _ = run_cmd(bv_re, 524288, rm_argv)
        ...
        val r3 = run_cmd(bv_me, 524288, make_argv)
        ...
        val r4 = run_cmd(bv_cpe, 524288, cp_argv)
                ...
                in
                  ...
                  in scan_bins(d, ph, phlen, rel, fuel - 1) end
                    ...
                    val rl = (if bin_bt > 0 then let
                      ...
                      val wlr = run_cmd(bv_wld, 524288, wl)
                    ...
                    (* Remove the first "PATH=..." token and "cc" token,
                       start argv from "cc" *)
                    val lr = run_cmd(bv_cce, 524288, link_argv)
          ...
          | ~$R.ok(tcfd) => let
            ...
            in
              if tcl2 > 0 then let
                ...
                val _ = run_cmd(bv_cpe, 524288, cp_argv)
                val () = $A.drop<byte>(fz_cpe, bv_cpe)
                val () = $A.free<byte>($A.thaw<byte>(fz_cpe))
                (* Generate Makefile *)
