...
implement run_patsopt(ph, phlen, out_bv, out_len, in_bv, in_len) = let
  ...
  val () = $B.put_byte_safe(argv_b, 0)
  val () = $B.bput(argv_b, "-IATS")
  val () = $B.put_byte_safe(argv_b, 0)
  val () = $B.bput(argv_b, "build")
  val () = $B.put_byte_safe(argv_b, 0)
  val () = $B.bput(argv_b, "-IATS")
  val () = $B.put_byte_safe(argv_b, 0)
  val () = $B.bput(argv_b, "build/src")
  val () = $B.put_byte_safe(argv_b, 0)
  val () = $B.bput(argv_b, "-IATS")
  val () = $B.put_byte_safe(argv_b, 0)
  val () = $B.bput(argv_b, "build/bats_modules")
  val () = $B.put_byte_safe(argv_b, 0)
  val () = $B.bput(argv_b, "-o")
  val () = $B.put_byte_safe(argv_b, 0)
